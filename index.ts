    ...
    try {
        ...
        console.log('Uploading to QQ for ' + userId);
            try {
                ...
                console.error('Unable to send Uploading for ' + userId, (e as Error).toString());
            }
        ...
        try {
            ...
            console.error('Unable to send Downloading from QQ for ' + userId, (e as Error).toString());
        }
